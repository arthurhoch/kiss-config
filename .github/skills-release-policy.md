...
This repository publishes versioned Markdown skill files under <code>docs/skills/</code> so AI agents can use KissConfig accurately from other projects.
...
3. Include the Maven coordinate <code>io.github.arthurhoch:kiss-config:&lt;release&gt;</code>.
...
6. Update <code>docs/skills/index.md</code> with both links:
   ...
   - Download: <code>https://raw.githubusercontent.com/arthurhoch/kiss-config/main/docs/skills/v0.2.0.md</code>
...
~~~text
https://raw.githubusercontent.com/arthurhoch/kiss-config/main/docs/skills/vX.Y.Z.md
~~~
